...
// คู่มือติดตั้ง: ดูในไฟล์ INSTALL_APPS_SCRIPT.md
const APPS_SCRIPT_URL = 'https://script.google.com/macros/s/AKfycbyVC8GYiUVbEWwejMkUF1F40rDAZIqT8bOPXpMRtS3uXEU0PmGReMddytarVzrmSife/exec'; // ⚠️ แก้ตรงนี้!
...
const USE_APPS_SCRIPT = false; // ⚠️ แก้เป็น true เมื่อใส่ URL แล้ว
...
async function addReview(name, text, rating) {
    ...
    if (USE_APPS_SCRIPT && APPS_SCRIPT_URL !== 'https://script.google.com/macros/s/AKfycbyVC8GYiUVbEWwejMkUF1F40rDAZIqT8bOPXpMRtS3uXEU0PmGReMddytarVzrmSife/exec') {
